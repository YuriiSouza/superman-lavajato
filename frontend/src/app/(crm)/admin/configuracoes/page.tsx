...
export default function ConfiguracoesPage() {
  ...
  useEffect(() => {
    crm.settings.get('company_info')
      .then((d) => { if (d.value) setCompany({ ...SITE_DEFAULTS, ...JSON.parse(d.value) }); })
  ...
  async function handleSaveCompany(e: React.FormEvent) {
    ...
    try {
      ...
      setCompanyMsg({ type: 'success', text: 'Informações salvas com sucesso.' });
    } catch {
  ...
  return (
    <div className="p-4 md:p-6 space-y-2">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Gerencie sua conta e as informações da empresa</p>
      </div>
              ...
              <form onSubmit={handleSaveCompany} className="space-y-5">
                ...
                <fieldset className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Slogan</label>
                      <input
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Descrição (SEO / meta description)</label>
                    <textarea
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                      <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                        WhatsApp <span className="font-normal text-gray-400">(só dígitos, com DDI)</span>
                      </label>
                      <input
                        value={company.phone}
                        onChange={(e) => setCompany({ ...company, phone: e.target.value.replace(/\D/g, '') })}
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Telefone <span className="font-normal text-gray-400">(exibição no site)</span>
                      </label>
                      <input
                ...
                <fieldset className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                      <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Instagram</label>
                      <input
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Facebook</label>
                      <input
                ...
                <fieldset className="space-y-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                      Link embed <span className="font-normal text-gray-400">(iframe src — termina com &output=embed)</span>
                    </label>
                    <input
                      value={company.mapsEmbed}
                      onChange={(e) => setCompany({ ...company, mapsEmbed: e.target.value })}
                      className={inputCls}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setCompany({ ...company, mapsDirections: e.target.value })}
                      className={inputCls}
                    />
                  </div>
                </fieldset>
                ...
                >
                  {companySaving ? 'Salvando...' : 'Salvar informações da empresa'}
                </button>
              </form>
            )}
          </Card>
              ...
              <form onSubmit={handleSaveTemplate} className="space-y-3">
                <div className="flex flex-wrap gap-1.5">
                  {PLACEHOLDERS.map((p) => (
                    ...
                    >
                      {p.key}
                      <span className="font-sans text-blue-400 dark:text-blue-500">→ {p.label}</span>
                    </button>
                  ))}
                </div>

...
export class FinancialController {
  ...
  @Get("summary")
  @ApiOperation({
    summary: "Resumo financeiro por período ou intervalo de datas",
  })
  ...
  @Get("profit")
  @ApiOperation({
    summary: "Lucro líquido real para um período (receita − despesas − CMV)",
  })
  @ApiQuery({ name: "period", required: false })
  @ApiQuery({ name: "start", required: false })
  @ApiQuery({ name: "end", required: false })
  ...
  @Get("dre")
  @ApiOperation({
    summary: "DRE: Receita, Despesas, CMV e Lucro Líquido por mês",
  })
  ...
  createReserve(
    @Body() body: { billId: string; amount: number; description?: string },
  ) {

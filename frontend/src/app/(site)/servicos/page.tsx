    ...
    <>
              ...
              {services.map((s) => (
                ...
                >
                  ...
                  <p className="mt-1 flex items-center gap-1.5 text-xs text-zinc-500">
                    ...
                    Duração {formatDuration(s.duration)}
                  </p>
                  ...
                  <a
                    href={whatsappLink(
                      site.phone,
                      `Olá! Quero agendar o pacote *${s.name}* (${formatPrice(s.price)}) no ${site.name}. 🦸`,
                    )}
                    target="_blank"
      ...
      <section id="agendar" className="scroll-mt-24 py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl items-start gap-12 px-4 sm:px-6 lg:grid-cols-2">
          ...
          <BookingForm services={services} whatsappPhone={site.phone} />
        </div>
      </section>
    </>
  );
